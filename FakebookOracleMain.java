...
public final class FakebookOracleMain {
    // Member Variables
    private static String username = "vedangp"; // replace with your uniqname
    private static String password = "eecsclass"; // replace with your Oracle password (default: eecsclass)
